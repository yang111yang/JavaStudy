...
<%-- 
 ...
 <html>
 	...
 	<body>
 		...
 		<hr>
 		<%
 			String str = "jsp学习真的很简单";
 			String str1 = "jsp如果业务逻辑书写过多，阅读会非常困难";
 			int a = 2;
 			if(a > 3){
 		 %>
 		 <p><%=str %></p>
 		 ...
 		 <%!
 		 	public void test(){
 		 		System.out.println("Jsp中书写业务逻辑代码真的好困难");
 		 	}
 		  %>
 		  <!-- jsp的静态引入 -->
 		  <%@include file="03-includeStatic.jsp" %>
 		  <!-- jsp的动态引入 -->
 		  <jsp:include page="04-includeActive.jsp"></jsp:include>
